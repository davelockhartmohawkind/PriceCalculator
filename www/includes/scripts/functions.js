 ...
 */
    ...
    var newhtml = 'Version: ' + 'V1.1.57 <br />';// +
    //if (device != null) {
    //    alert(newhtml);
    //    alert(device.uuid);
    //}
...
function setDealerList(dealerName) {
    ...
    if (data == undefined || data == null || data == "") {
        ...
        data = localStorage['mohawkDealers']
    ...
    SortedDealers = Dealers.sort(function (obj1, obj2) {
        ...
        if (obj1.name == 'Default_Profile') {
            return 1;
        }
        if (obj2.name == 'Default_Profile') {
            return -1;
        }

        
        return ((obj1.name.toLowerCase() < obj2.name.toLowerCase()) ? -1 : ((obj1.name.toLowerCase() > obj2.name.toLowerCase()) ? 1 : 0));
...
function setDealerData(dealerName) {
    ...
    //get matching dealer
    var filteredDealer = $.grep(SortedDealers, function (item) {
        if (item != null) {
